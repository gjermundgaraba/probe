module github.com/cosmos/probe/interchaintest
...
replace github.com/strangelove-ventures/interchaintest/v8 => github.com/gjermundgaraba/interchaintest/v8 v8.0.0-20250221173724-6cd95a77890c
